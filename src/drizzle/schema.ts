...
import { integer, pgEnum, pgTable, varchar, date, text, timestamp, } from "drizzle-orm/pg-core";
...
export const educationEnum = pgEnum("education", ["none", "high school", "undergraduate", "masters", "phd",]);
...
export const users = pgTable("user", {
    ...
    role: rolesEnum("role").default("applicant"),
